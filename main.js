...
function hydrateHaleIntelligence(){
 const shell=(active,content)=>`<div class="product-nav"><b><img src="/assets/mascot/violet-portrait.webp" alt="" width="26" height="26">violet</b><span>Dashboard</span><span>Inbox</span><span class="nav-active">Cases</span><span>Tasks</span><span>Reports</span><span>More ▾</span><span class="nav-right"><i>⚙</i><i>Demo Investigator</i><b class="nav-cta">+ New case</b></span></div><div class="product-body"><div class="case-heading"><h3>Victor Hale</h3><span class="case-status">Open ▾</span><span>INV-2026-0062 · opened Mar 24 · 12 days</span></div><div class="case-tabs"><span>Overview</span><span>Intake</span><span class="tab-active">Investigation</span><span>Documents</span><span>Report</span><span>Resolution</span><span class="subtabs"><i>Plan</i><i>Interviews</i><i class="${active==='Evidence Matrix'?'on':''}">Evidence</i><i class="${active==='Timeline'?'on':''}">Timeline</i></span></div>${content}</div>`;
