...
// Local-only visual preview. This calls no submission handler or network request.
if(['localhost','127.0.0.1','[::1]'].includes(location.hostname)&&new URLSearchParams(location.search).get('preview')==='delivery')playDelivery('Preview');
